    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                x-data="{ isOpen:false }"                
                >
                    <?php if(count($movie['videos']) > 0): ?>
                    <div class="mt-12">
                        <button 
                        @click="isOpen=true"
                        href="https://youtube.com/watch?v=<?php echo e($movie['videos'][0]['key']); ?>" 
                            ...
                            <div class="bg-gray-900 rounded">
                                ...
                                <div class="modal-body px-8 py-8">
                                    <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                        <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/<?php echo e($movie['videos'][0]['key']); ?>" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="movie-cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="<?php echo e('https://image.tmdb.org/t/p/w300' . $cast['profile_path']); ?>" alt="parasite" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2">Name</a>
                        <div>
                            <a href="#" class="mt-1 text-sm text-gray-300 hover:text-gray-300"><?php echo e($cast['name']); ?></a>
                        </div>                   
                    </div>
                </div>                           
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravelProjects\movies\resources\views/show.blade.php ENDPATH**/ ?>