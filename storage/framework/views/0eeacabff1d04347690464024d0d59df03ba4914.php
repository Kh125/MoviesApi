...
<?php $__env->startSection('content'); ?>
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">                
                <img src="<?php echo e($actor['profile_path']); ?>" alt="actor_image" class="w-70 md:w-96">
                <ul class="flex items-center mt-6">
                    <?php if($actor_external_ids['facebook']): ?>                        
                        <li class="mr-6">
                            <a href="<?php echo e($actor_external_ids['facebook']); ?>" title="Facebook">
                    ...
                    <?php endif; ?>
                    <?php if($actor_external_ids['instagram']): ?>                        
                        <li class="mr-6">
                            <a href="<?php echo e($actor_external_ids['instagram']); ?>" title="Instagram">
                    ...
                    <?php endif; ?>
                    <?php if($actor_external_ids['twitter']): ?>                        
                        <li class="mr-6">
                            <a href="<?php echo e($actor_external_ids['twitter']); ?>" title="Twitter">
                    ...
                    <?php if($actor['homepage']): ?>
                        <li class="mr-6">
                            <a href="<?php echo e($actor['homepage']); ?>" title="Website">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm mt-2">
                    ...
                    <span class="ml-1">&nbsp; <?php echo e($actor['birthday']); ?> &nbsp;(<?php echo e($actor['age']); ?> years old)&nbsp;</span>  
                    <span>in <?php echo e($actor['place_of_birth']); ?></span>                  
                </div>
                <div class="text-gray-300 mt-8">
                    <?php echo e($actor['biography']); ?>

                </div>
                <h4 class="text-2xl font-bold mt-16">
                    Known For
                </h4>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 mt-4">
                    <?php $__currentLoopData = $knownForTitles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                        
                        <div class="mt-4 aa">
                            <a href="<?php echo e(route('movies.show', $movie['id'])); ?>">
                                <img src="<?php echo e($movie['poster_path']); ?>" alt=""
                                class="hover:opacity-75 traisition ease-in-out duration-150"
                                >
                            </a>
                            <a href="<?php echo e(route('movies.show', $movie['id'])); ?>" class="text-sm leading-normal block text-gray-400 hover:text-white mt-1"><?php echo e($movie['title']); ?></a>
                        </div>                                                                                
        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <ul class="list-disc leading-loose pl-5 mt-8">
                <?php $__currentLoopData = $credits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $credit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                    
                    <li class="">
                        <?php echo e($credit['release_year']); ?> &middot;
                        <strong><a href="<?php echo e(route('movies.show', $credit['id'])); ?>" class="hover:underline"><?php echo e($credit['title']); ?></a></strong>
                        <?php if($credit['character'] != ''): ?>
                            as
                        <?php endif; ?>
                        <?php echo e($credit['character']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\Laravel\movies\resources\views/actors/show.blade.php ENDPATH**/ ?>