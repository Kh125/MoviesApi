    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-16 mt-3 md:mt-0 place-self-start md:place-self-center">
                    <a href="<?php echo e(route('movies.index')); ?>" class="hover:text-gray-300">Movies</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0 place-self-start md:place-self-center">
            ...
            <div class="flex flex-col md:flex-row items-center mt-5 sm:mt-5 md:mt-0">
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('search-dropdown', [])->html();
} elseif ($_instance->childHasBeenRendered('MleJOv1')) {
    $componentId = $_instance->getRenderedChildComponentId('MleJOv1');
    $componentTag = $_instance->getRenderedChildComponentTagName('MleJOv1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MleJOv1');
} else {
    $response = \Livewire\Livewire::mount('search-dropdown', []);
    $html = $response->html();
    $_instance->logRenderedChild('MleJOv1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH E:\Projects\Laravel\movies\resources\views/layouts/app.blade.php ENDPATH**/ ?>